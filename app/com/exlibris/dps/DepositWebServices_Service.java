 ...
 * 
 */
@WebServiceClient(name = "DepositWebServices", targetNamespace = "http://dps.exlibris.com/", wsdlLocation = "http://rosetta.develop.lza.tib.eu/dpsws/deposit/DepositWebServices?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://rosetta.develop.lza.tib.eu/dpsws/deposit/DepositWebServices?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://rosetta.develop.lza.tib.eu/dpsws/deposit/DepositWebServices?wsdl', retrying as a local file");
